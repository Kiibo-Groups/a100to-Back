                    ...
                    <div class="card py-3 m-b-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="text-align: right;">
                                <a href="{{ Asset($link . 'add') }}" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-warning">Add
                                    New</a>&nbsp;&nbsp;&nbsp;
                            </div>
                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="name" id="name" value="{{ $name }}"
                                                placeholder="Busca por nombre" class="form-control" autocomplete="off">
                                        </div>
                                        ...
                                        @if ($user->subtype == 0)
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="type" class="form-control" id="type">
                                                    <option value="0"
                                                        @if ($type == 0) selected @endif>De Menú</option>
                                                    <option value="1"
                                                        @if ($type == 1) selected @endif>De Complementos
                                                    </option>
                                                </select>
                                            </div>
                                        @endif
