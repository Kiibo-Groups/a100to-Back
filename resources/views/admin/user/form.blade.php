...
@if(isset($admin))
    ...
    <div class="card py-3 m-b-30">
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="purse_x_pickup">% a monedero electrónico en recoger en tienda:</label>
                    <input type="text" name="purse_x_pickup" id="purse_x_pickup" value="{{$data->purse_x_pickup}}" class="form-control">
                </div>
                <div class="form-group col-md-6">
                    <label for="purse_x_delivery">% a monedero electrónico servicio a domicilio:</label>
                    <input type="text" name="purse_x_delivery" id="purse_x_delivery" value="{{$data->purse_x_delivery}}" class="form-control">
                </div>
                <div class="form-group col-md-6">
                    <label for="purse_x_table">% a monedero electrónico en mesa:</label>
                    <input type="text" name="purse_x_table" id="purse_x_table" value="{{$data->purse_x_table}}" class="form-control">
                </div>
            </div> 
        </div>
    </div>
