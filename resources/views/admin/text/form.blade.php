<div class="tab-content" id="myTabContent1">
    ...
    @foreach ($langs as $l)
        ...
        <div class="tab-pane fade show @if ($l['id'] == 0) active @endif" id="lang{{ $l['id'] }}"
            role="tabpanel" aria-labelledby="lang{{ $l['id'] }}-tab">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="item_addon_button[]" class="form-control"
                                value="{{ $data->getSData($l['id'], 'item_addon_button') }}">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="confirm_total[]" class="form-control"
                                value="{{ $data->getSData($l['id'], 'confirm_total') }}">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="d_pay[]" class="form-control"
                                value="{{ $data->getSData($l['id'], 'd_pay') }}">
                        </div>
