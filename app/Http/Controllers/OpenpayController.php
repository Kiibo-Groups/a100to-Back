...
class OpenpayController extends BaseController
{
    ...
    function addClient($data)
	{
        ...
        return $this->CurlGet($fields,"https://<>/app/api/addClient");
	}
    ...
    function getClient($data)
	{
        ...
        return $this->CurlGet($fields,"https://<>/app/api/getClient");
    }

    // Agregamos tarjeta al cliente
    function SetCardClient($data)
    {
        return $this->CurlGet($data,"https://<>/app/api/SetCardClient");
    }
    ...
    function getCardsClient($data)
    {
        ...
        return $this->CurlGet($fields,"https://<>/app/api/getCardsClient");
    }
    ...
    function DeleteCard($data)
    {
        ...
        return $this->CurlGet($data,"https://<>/app/api/deleteCardClient");
    }
    ...
    function getCard($data)
    {
        ...
        return $this->CurlGet($data,"https://<>/app/api/GetCardclient");
    }
    ...
    function chargeClient($data)
    {
        ...
        return $this->CurlGet($data,"https://<>/app/api/chargeClient");
    }
