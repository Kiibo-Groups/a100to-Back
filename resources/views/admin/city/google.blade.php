<input id="pac-input" class="controls form-control" name="name" value="{{ $data->name }}" type="text"
...
<div class="form-group col-md-6"><input type="text" hidden name="h3index" id="h3index" class="form-control"
        required placeholder="h3index" value="{{ $data->h3index }}"></div>
