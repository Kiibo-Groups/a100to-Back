    ...
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputEmail6">selecciona una categoría <small>(Debes Agregarlas en area de
                        categorias)</small></label>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                {!! Form::text('small_price', null, [
                    'id' => 'code',
                    'placeholder' => 'Precio final al consumidor',
                    'class' => 'form-control',
                ]) !!}
            </div>
