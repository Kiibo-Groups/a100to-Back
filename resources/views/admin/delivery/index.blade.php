...
@section('title')
    Administrar personal de entrega
@endsection
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        @if ($row->type_driver == 0)
                                                            <img src="{{ Asset('assets/img/type_car.png') }}" alt="Auto"
                                                                style="width:80px;">
                                                        @elseif($row->type_driver == 1)
                                                            <img src="{{ Asset('assets/img/type_moto.png') }}"
                                                                alt="Auto" style="width:80px;">
                                                        @elseif($row->type_driver == 2)
                                                            <img src="{{ Asset('assets/img/type_bici.png') }}"
                                                                alt="Auto" style="width:80px;">
                                                        @endif
                                                    </td>
                                                    <td width="20%">
                                                    ...
                                                    <td width="15%">
                                                        @if ($row->amount_acum == 0)
                                                            <!-- Saldo a favor -->
                                                            <h6 style="color:blue;">
                                                                {{ $currency }}{{ number_format($row->amount_acum, 2) }}
                                                            </h6>
                                                        @elseif($row->amount_acum > 0)
                                                            <!-- Saldo a favor -->
                                                            <h6 style="color:red;" data-toggle="tooltip"
                                                                data-placement="top"
                                                                data-original-title="Tiene un saldo a favor de:">
                                                                {{ $currency }}{{ number_format($row->amount_acum, 2) }}
                                                                <i class="mdi mdi-trending-down"></i></h6>
                                                        @else
                                                            <!-- Saldo que debe -->
                                                            <?php
                                                            $sal = str_replace('-', '', $row->amount_acum);
                                                            ?>
                                                            <h6 style="color:green;" data-toggle="tooltip"
                                                                data-placement="top"
                                                                data-original-title="Tiene un saldo deudor de:">
                                                                {{ $currency }}{{ number_format($sal, 2) }} <i
                                                                    class="mdi mdi-trending-up"></i> </h6>
                                                        @endif
                                                    </td>
                                                    <td width="5%">
                                                        @if ($row->status == 0)
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmAlert('{{ Asset($link . 'status/' . $row->id) }}')"
                                                                data-toggle="tooltip" data-placement="top"
                                                                data-original-title="Activar"><i
                                                        ...
                                                        @else
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmAlert('{{ Asset($link . 'status/' . $row->id) }}')"
                                                                data-toggle="tooltip" data-placement="top"
                                                                data-original-title="Desactivar"><i
                                                                    class="mdi mdi-disc"></i></a>
                                                        @endif
                                                    </td>
                                                    <td width="5%">
                                                        @if ($row->status_admin == 0)
                                                            ...
                                                            <a href="#"
                                                                class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-success"
                                                                onclick="confirmAlert('{{ Asset($link . 'status_admin/' . $row->id) }}')"
                                                                data-toggle="tooltip" data-placement="top"
                                                                data-original-title="Activar"><i
                                                                    class="mdi mdi-disc"></i></a>
                                                        @else
                                                            ...
                                                            <ul class="dropdown-menu"
                                                                ...
                                                                <li>
                                                                    <a href="javascript::void()" class="dropdown-item"
                                                                        onclick="showMsg('Username : {{ $row->phone }}<br>Password : {{ $row->shw_password }}')">
                                                                        Ver Accesos
                                                                    </a>
                                                                </li>
                                                                <!-- Edit -->
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <input type="hidden" name="staff_id"
                                                                        value="{{ $row->id }}">
                                                                    <input type="hidden" name="type_report"
                                                                        value="excel">
