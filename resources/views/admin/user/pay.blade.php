                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        @if ($data->saldo == 0)
                                            ...
                                            <br />
                                            <!-- Saldo a favor -->
                                            <h3 style="color:blue;">{{ $currency }}{{ number_format($data->saldo, 2) }}
                                            </h3>
                                        @elseif($data->saldo > 0)
                                            <label for="inputEmail6">Tiene un saldo a favor de</label>
                                            <br />
                                            <!-- Saldo a favor -->
                                            <h3 style="color:red;">{{ $currency }}{{ number_format($data->saldo, 2) }}
                                            </h3>
                                        @else
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" id="new_saldo" name="new_saldo"
