...
class NodejsServer extends BaseController
{
    ...
    */
    ...
    {
        return $this->CurlGet($data,"https://<>/app/api/newOrder/");
    }

    function orderStatus($data)
    {
        return $this->CurlGet($data,"https://<>/app/api/orderStatus/");
    }
    
    function setStaffDelivery($data)
    {
        return $this->CurlGet($data,"https://<>/app/api/setStaffDelivery/");
    }

    function delStaffDeliveryOrder($data)
    {
        return $this->CurlGet($data,"https://<>/app/api/delStaffDeliveryOrder/");
    }
    ...
    */
    ...
    {
        return $this->CurlGet($data,"https://<>/app/api/newStaff/");
    }

    function updateStaffDelivery($data)
    {
        return $this->CurlGet($data,"https://<>/app/api/updateStaff/");
    }
    ...
    */
    ...
    function NewOrderComm($data)
    {
        ...
        return $this->CurlGet($fields,"https://<>/app/api/newOrderComm/");
    }
    ...
    function notifyClient($data)
    {
        ...
        return $this->CurlGet($fields,"https://<>/app/api/InitCronOrder/");
    }
