                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="v_count" id="v_count" class="form-control">
                                                    <option value="0" @if($data->v_count == 0) selected @endif>Horas</option>
                                                    <option value="1" @if($data->v_count == 1) selected @endif>Días</option>
                                                    <option value="2" @if($data->v_count == 2) selected @endif>Semanas</option>
                                                    <option value="3" @if($data->v_count == 3) selected @endif>Meses</option>
                                                </select>
                                            </div>
        
                                            <div class="form-group col-md-6">
                                                <label for="v_value">Tiempo</label>
                                                <input type="text" name="v_value" id="v_value" value="{{$data->v_value}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="t_value_comm" value="{{$data->t_value_comm}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
