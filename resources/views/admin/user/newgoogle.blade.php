<input id="pac-input" class="controls form-control" name="address" value="{{ $data->address }}" type="text"
    placeholder="Enter a location">

<br>

<div class="row">
    <div class="form-group col-md-6"><input type="hidden" name="lat" id="lat" class="form-control" required
            placeholder="Latitude" value="{{ $data->lat }}"></div>
    <div class="form-group col-md-6"><input type="hidden" name="lng" id="lng" class="form-control" required
            placeholder="Longitude" value="{{ $data->lng }}"></div>
</div>
